...
?>
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>赛事评价</h1></div>
    <div class="box-content">
        ...
        <div class="box-table">
            <table class="list">
                <thead>
<?php 
    $o_type= QmddAchievemen::model()->findAll('f_type=351');
?>
                    <tr>
                        ...
                        <?php } ?>
                        <th style="text-align: center;"><?php echo $model->getAttributeLabel('evaluate_info');?></th>
...
?>
                    <tr>
                        ...
                        <?php if(!empty($eval_list))foreach($eval_list as $v1){ ?>
                            <td style="text-align: center"><?php if($v1->f_mark1==0||$v1->f_mark1==1||$v1->f_mark1==2||$v1->f_mark1==3||$v1->f_mark1==4||$v1->f_mark1==5)echo $mark[$v1->f_mark1]; ?></td>
                        <?php } ?>
                        <td style="text-align: center"><?php echo $v->evaluate_info; ?></td>
                        <td style="text-align: center"><?php echo $v->evaluate_time; ?></td>
                        <td style="text-align: center"><?php echo $v->gf_zsxm; ?></td>
                        <td style='text-align: center;'>
                            <a class="btn" href="<?php echo $this->createUrl('game_update', array('id'=>$v->f_id));?>" title="详情"><i class="fa fa-edit"></i></a>
                        </td>
                    </tr>
<?php $index++;} ?>
                </tbody>
