<div class="box"></div>
    <div class="box-title c">
        <h1>当前界面：动动约 》服务退订 》<a class="nav-a">退订审核</a></h1>
        <span class="back"><a href="javascript:;" class="btn" onclick="we.reload();">刷新</a></span>
    </div>
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="<?php echo $this->createUrl('returnGoods/index_service_check');?>">待审核(<span class="red"><b><?php echo $count1; ?></b></span>)</a>
        </div>
        ...
        <div class="box-table">
            <table class="list">
                <thead>
                    ...
                    <th>服务单位</th>
                    <th style="width:70px;">审核时间</th>
                    <th><?php echo $model->getAttributeLabel('state_user_id'); ?></th>
...
<?php if(!empty($v->orderdata)) $list = GfServiceData::model()->find('id='.$v->orderdata->gf_service_id); ?>
                        <tr>
                            ...
                            <td><?php echo $v->state_user_gfaccount; ?>/<?php echo $v->state_user_name; ?></td>
                            <td><?php echo $v->desc; ?></td>
                            <td><a class="btn" href="<?php echo $this->createUrl('update_service_check', array('id'=>$v->id,'list'=>'pass'));?>" title="详情">详情</a></td>
                        </tr>
                    <?php $index++; }?>
                </tbody>
            </table>
