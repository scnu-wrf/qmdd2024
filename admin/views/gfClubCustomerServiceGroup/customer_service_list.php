        ...
        <div class="box-table">
            <table class="list">
                ...
                <tbody>
					...
					?>
					<?php 
						$server=Yii::app()->db->createCommand("select a.admin_gfaccount,a.admin_gfnick,u.ZSXM as admin_name,a.is_on_line,a.last_login from gf_user_1 as u,qmdd_administrators as a where u.GF_ID=a.admin_gfid and a.id=".$v->admin_id)->queryRow();
					?>
                    <tr>
