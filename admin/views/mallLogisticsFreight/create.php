<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>添加运费列表</h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span></div><!--box-title end-->
        ...
        <?php  $form = $this->beginWidget('CActiveForm', get_form_list()); ?>
            <table class="detail">
                <tr>
                    ...
                    <td>
<?php echo $form->hiddenField($model, 'logistic_id', array('value'=>$_REQUEST['pid'])); ?>
                    </td>
                </tr>
                <tr>
