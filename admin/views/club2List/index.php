...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>部门管理</h1></div>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;"><?php echo $model->getAttributeLabel('club2_code');?></th>
...
?>
                    <tr>
                        ...
                        <td style="text-align: center"><?php echo $v->club2_code; ?></td>
