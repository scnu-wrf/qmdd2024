...
<div class="box">
    <div class="box-title c">
        <h1> <span>当前界面：项目 》项目设置 》单位项目等级设置</span> </h1>
    ...
    <div class="box-content"> 
        <div class="box-header"> 
            <a class="btn" href="<?php echo $this->createUrl('create_dwxm');?>"><i class="fa fa-plus"></i>添加</a> 
        ...
        <tbody>   
          <?php $index = 1;foreach($arclist as $v){?>
            <tr>
                ...
                <td>
                    <?php echo show_command('修改',$this->createUrl('update_dwxm', array('id'=>$v->id))); ?>
