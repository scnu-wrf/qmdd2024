...
<div class="box">
    <div class="box-title c">
        <h1> <span>当前界面：会员 》会员设置 》GF会员等级设置</span> </h1>
    ...
    <div class="box-content"> 
        <div class="box-header"> 
            <a class="btn" href="<?php echo $this->createUrl('create_gf');?>"><i class="fa fa-plus"></i>添加</a> 
        ...
        <tbody>   
          <?php $index = 1;foreach($arclist as $v){?>
            <tr>
                ...
                <td>
                    <?php echo show_command('修改',$this->createUrl('update_gf', array('id'=>$v->id))); ?>
