...
<html lang="zh">
    ...
    <body>
        <div class="box">
            <div class="box-title c"><h1><i class="fa fa-table"></i>导入单位学员</h1></div><!--box-title end-->
                ...
                <div class="box-table">
                    <table class="list" >
                        ...
                        <tr>
                            ...
                            <td>
                                <a  class="btn" href="<?php echo Yii::app()->request->baseUrl.'/admin/views/clubMemberList/学员模板.xlsx';?>">下载信息模板</a>
                            </td>
                        </tr>
                    </table>
                </div> <!-- box-table -->
