<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>编辑属性详情</h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span></div><!--box-title end-->
    <div class="box-content">
        <div class="box-table">
            <?php  $form = $this->beginWidget('CActiveForm', get_form_list()); ?>
            <table class="detail">   
                <tr>
                  <th class="detail-hd"><?php echo $form->labelEx($model, 'attr_code'); ?></th>
                  <td><?php echo $model->attr_code;?></td>
                </tr>            
                <tr>
