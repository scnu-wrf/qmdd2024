...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>商品属性列表</h1></div><!--box-title end-->
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('if_del');?></th>
...
?>
                    <tr>
                        ...
                        <td style='text-align: center;'><?php if($v->ifdel!=null){ echo $v->ifdel->F_NAME; } ?></td>
                        <td style='text-align: center;'>
                        <a class="btn" href="<?php echo $this->createUrl('index1',array('pid' => $v->id));?>" title="属性列表">属性列表</a>
