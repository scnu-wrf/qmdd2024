            ...
            <div class="box-detail-tab-item">
                ...
                <table id="timelist" class="showinfo" data-num="new">
                    ...
                    <tr class="item" data-id="new">
                        <td><input style="width:80%;" class="service-date input-text" type="text" name="timelist[new][start_date]" value="" onclick="fnSetDate(this);" readonly></td>
                        <td><input style="width:80%;" class="service-date input-text" type="text" name="timelist[new][end_date]" value="" onclick="fnSetDate(this);" readonly></td>
                        <td><input style="width:30%;" class="service-date-num input-text" type="text" name="timelist[new][num]" value=""></td>
                        <td><input style="width:80%;" class="input-text" type="text" value="" onclick="fnSetProductData(this);" readonly><input class="service-date-product" type="hidden" name="timelist[new][product_data_id]" value=""></td>
...
var fnAddServiceDate=function(){
    ...
    var html='<tr class="item" data-id="'+timelist_num+'">'+
        ...
        '<td style="text-align:left;"><input onclick="fnAddServiceDate();" class="btn" type="button" value="添加行">&nbsp;&nbsp;&nbsp;<input onclick="fnRemoveServiceDate(this);" class="btn" type="button" value="删除行"></td>'+
    '</tr>';
