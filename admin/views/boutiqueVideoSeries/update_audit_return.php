...
<div class="box">
    <div class="box-title c"><h1>当前界面：视频》视频分集管理》发布视频分集》<a class="nav-a">详情</a></h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回上一层</a></span></div><!--box-title end-->
		...
		<div class="box-detail-bd" style="margin-top: 10px;">
			...
			<table>
				<tr>
					...
					<td colspan="3" style="color:#7a7a7a"><?php echo $model->state_name;?></td>
				</tr>
				<tr>
					<td>操作备注</td>
					<td colspan="3" style="color:#7a7a7a">
				...
				<tr>
					<td>可执行操作</td>
					<td colspan="3" style="color:#7a7a7a">
						<a href="<?php echo $this->createUrl('update', array('id'=>$model->id));?>"><button id="chongbian" class="btn btn-blue" type="button">重新编辑</button></a>
