<div class="box">
    ...
    <h1><?php if($_REQUEST['index']==1){echo '当前界面：战略伙伴》单位认证管理》单位认证审核';}elseif($_REQUEST['index']==2){echo '当前界面：战略伙伴》单位认证管理》单位认证审核》待审核';}elseif($_REQUEST['index']==3){echo '当前界面：战略伙伴》单位认证管理》单位认证取消/审核未通过';}elseif($_REQUEST['index']==4){echo '当前界面：战略伙伴》战略伙伴管理》战略伙伴列表';}elseif($_REQUEST['index']==5){echo '战略伙伴管理->战略伙伴已注销列表';}elseif($_REQUEST['index']==6){echo '当前界面：战略伙伴 》战略伙伴认证 》认证待审核';}?></h1></div><!--box-title end-->
    <div class="box-content">
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <?php if($_REQUEST['index']==1||$_REQUEST['index']==4||$_REQUEST['index']==6){?>
                    <label style="margin-right:10px;">
                        <span><?php if($_REQUEST['index']==1){echo '审核日期：';}elseif($_REQUEST['index']==6){echo '申请日期：';}else{echo '入驻时间：';};?></span>
				...
				<label style="margin-right:20px;">
                    <span>战略伙伴类型：</span>
                    <?php echo downList($partnership_type,'member_second_id','member_second_name','type'); ?>
                </label>
                <label style="margin-right:10px;">
                    <span>关键字：</span>
                ...
                <thead>
                    <tr>
                        ...
                        <?php }elseif($_REQUEST['index']==5){ ?>
                            ...
                            <th><?php echo $model->getAttributeLabel('reasons_for_failure');?></th>
                            <th>操作</th>
                ...
                <tbody>
                    ...
                    <tr> 	   
                        <?php if($_REQUEST['index']==1){ ?>   
                            ...
                            <td><?php if(!empty($v->enter_project_id))echo $v->enter_project->project_name;  ?></td>
                        ...
                        <?php }elseif($_REQUEST['index']==2){ ?> 
                            ...
                            <td><?php echo $v->contact_phone;?></td>
                            <td><?php echo $v->edit_state_name;?></td>
                            <td><?php echo substr($v->edit_apply_time,0,10);?></td>
                            <td>
                        ...
                        <?php }elseif($_REQUEST['index']==5){?>
                            ...
                            <td><?php echo $v->apply_name;?></td>
                            <td><?php echo $v->contact_phone;?></td>
                            <td><?php echo substr($v->lock_date_start,0,10);  ?></td>
                            <td><?php echo $v->unit_state==507?'已注销':$v->unit_state_name;  ?></td>
                            <td><?php echo $v->reasons_adminname;  ?></td>
                            <td><?php echo $v->reasons_for_failure;  ?></td>
                            <td>
                                <?php echo show_command('修改',$this->createUrl('update_data', array('id'=>$v->id))); ?>
                            </td>
                        <?php }elseif($_REQUEST['index']==6){?>
                            <td><span class="num num-1"><?php echo $index; ?></td>
                            <td><?php echo CHtml::link($v->club_code, array('update', 'id'=>$v->id)); ?></td>
