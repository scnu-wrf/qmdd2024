...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>动动约预订收费明细表</h1></div><!--box-title end-->     
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>订单号：</span>
                    <input style="width:200px;" class="input-text" type="text" name="order_num" value="<?php echo Yii::app()->request->getParam('order_num');?>" placeholder="请输入订单编号">
                </label>
                <label style="margin-right:10px;">
                    <span>服务时间：</span>
                ...
                <label style="margin-right:20px;">
                    <span>关键字：</span>
                    <input style="width:150px;" class="input-text" type="text" name="keywords" value="<?php echo Yii::app()->request->getParam('keywords'); ?>" placeholder="请输入服务名称">
                </label>
