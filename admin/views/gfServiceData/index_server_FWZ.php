<div class="box">
    <div class="box-title c">
        <h1>当前界面：动动约》服务预订》<a class="nav-a">服务者明细</a></h1>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th>服务类别</th>
                        <th width="10%"><?php echo $model->getAttributeLabel('data_name');?></th>
                        <th>服务项目</th>
                        <th style="width:70px;"><?php echo $model->getAttributeLabel('service_data_name');?></th> 
                        ...
                        <th width="10%"><?php echo $model->getAttributeLabel('gf_name');?></th>
                        <th width="10%"><?php echo $model->getAttributeLabel('info_order_num');?></th>             
                        <th>操作</th>
                    </tr>
                </thead>
                <tbody>
            ...
            foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <!--a class="btn" href="javascript:;" onclick="checkval(<php=$v->id;?>,'one')">取消订单</a-->
...
// 获取所有选中多选框的值
    ...
    function fnCancel(id){
        ...
        $.ajax({
            type:'post',
            url:'<?php echo $this->createUrl('cancel'); ?>&id='+id,
            // data:{id:id},
            dataType:'json',
