...
<div class="box">
    <div class="box-title c">
        <h1><i class="fa fa-table"></i>会员预定查询</h1><br><br>
        <small>可按月查询各服务类别的预定人及所预定服务的详细情况</small>
    </div>
...
?>
                    <tr>
                        ...
                        <td style='text-align: center;'>
                            <a class="btn" href="<?php echo $this->createUrl('member_stat_update', array('id'=>$v->gfid,'projectId'=>$v->project_id,'typeId'=>$v->t_stypeid,'date'=>$myDate));?>" title="编辑"><i class="fa fa-edit"></i></a>
                        </td>
                    </tr>
<?php $index++;} ?>
                </tbody>
