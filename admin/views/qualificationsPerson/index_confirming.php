...
<div class="box">
    ...
    <div class="box-content">
        <div class="box-detail-tab" style="margin-top: 15px; border: 0px;">
            <ul class="c">
                <li class="current" style="width:150px; background-color: #FDE9D9;"><a href="<?php echo $this->createUrl('index_confirming'); ?>">待确认</a></li>
                <li style="width:150px;"><a href="<?php echo $this->createUrl('index_confirmed'); ?>">已确认</a></li>
            </ul>
        ...
        <div class="box-search">
            ...
            <div>
                <a class="btn btn-blue" style="margin-top: 3px;" href="javascript:;" onclick="checkval('.check-item input:checked');">批量确认</a>
            </div>
        </div><!--box-search end-->
        <div class="box-table">
            <thead>
