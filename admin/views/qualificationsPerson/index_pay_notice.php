...
<div class="box">
    ...
    <div class="box-title c">
        <h1>
            <span>当前界面：服务者 》入驻缴费管理 》待通知缴费</span>
        </h1>
        ...
        <div class="box-table">
            <table class="list">
                <tr>
                    ...
                    <th width="3%">序号</th>
                    <th width="10.7%"><?php echo $model->getAttributeLabel('qualification_gf_code') ?></th>
                    <th width="10.7%">账号姓名</th>
                    <th width="10.7%">持有资质</th>
                    <th width="10.7%"><?php echo $model->getAttributeLabel('qualification_project_id') ?></th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                            // if($v->free_state_Id==1200) {
                                // echo '<a class="btn btn-blue" href="javascript:;" onclick="send('.$v->id.',\'one\')">通知缴费</a>&nbsp;';
                            // }
                        ?>
                    </td>
                </tr>
        ...
        <div class="box-table" >
            <table class="list">
                <tr class="table-title">
                    <td colspan="2">
                        <p style="font-weight: bold;">请选择通知方式</p>
                    </td>
                </tr>
                <tr>
                    <td width="15%">入驻方式</td>
                    <td>
                        <label style="margin-right:20px;">
                            <input id="sky1" name="sky" class="sky" type="radio" value="0"><label for="sky1">有偿</label>
                            <input id="sky2" name="sky" class="sky" type="radio" value="1"><label for="sky2">免单</label>
                        </label>
                    </td>
                </tr>
                <tr id="tr_fee_list" style="display: none;">
                    <td>收费方案</td>
                    <td>
                        <label>
                        ...
                        <a href="javascript:;" id="loke_fee" style="display: block; float: right;">查看方案费用明细</a>
                ...
                <tr>
                    <td>操作</td>
                    <td>
                        <a class="btn btn-blue" href="javascript:;" onclick="send('.check-item input:checked')" style="margin:0 10px;">发送缴费通知</a>
                    </td>
                </tr>
            ...
            <div id="div_fee_list" class="dis_fee white_content" style="position: relative; top: -8px; display: none; margin: 0 auto; overflow: hidden;"></div>
        </div><!--box-header end-->
    </div><!--box-content end-->
</div><!--box end-->
<?php
...
<script>
    ...
    $("#sky1").on('change', function() {
        $("#tr_fee_list").attr('style', '');
    });
    $("#sky2").on('change', function() {
        $("#tr_fee_list").attr('style', 'display: none;');
    });
