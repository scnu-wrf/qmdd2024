<div class="box">
    ...
    <h1><i class="fa fa-table"></i>社区资质人邀请及解聘处理</h1><span class="back">
     ...
     <?php  $form = $this->beginWidget('CActiveForm', get_form_list());      ?>
        <div class="box-detail-bd">
            <div style="display:block;" class="box-detail-tab-item">
                <table class="mt15">
            <tr>
                <td width="15%"><?php echo $form->labelEx($model, 'invite_code'); ?></td>
                <td width="35%"><?php echo $model->invite_code;?></td>
                <td width="15%"><?php echo $form->labelEx($model, 'gfaccount'); ?></td>
                <td width="35%"><span class="label-box"><?php echo $model->qualification_person_account;?></span></span>
                 </td>
     </tr>
        <tr>
            <td ><?php echo $form->labelEx($model, 'qualification_name'); ?></td>
            <td ><?php echo $model->qualifications_person->qualification_name; ?>
          </td>
            <td ><?php echo $form->labelEx($model, 'qualification_title'); ?></td>
            <td >
                <?php echo $model->qualifications_person->qualification_title; ?>
          </td>
         </tr>
        <tr>
          <td ><?php echo $form->labelEx($model, 'project_id'); ?></td>
            <td >
            <span class="label-box"><?php echo $model->project_name;?></span>
          <td ><?php echo $form->labelEx($model, 'qualification_type'); ?></td>
            <td >
             <span class="label-box"><?php echo $model->qualifications_person->qualification_type;?></span>
            </td>
          </tr>
    <tr>
    ...
    <tr>
    <td ><?php echo $form->labelEx($model, 'code_year'); ?></td>
    <td >
     <span class="label-box"><?php echo $model->qualifications_person->qualification_code;?></span>
  </td>
    <td ><?php echo $form->labelEx($model, 'code_num'); ?></td>
    <td >
   <span class="label-box"><?php echo $model->qualifications_person->qualification_code;?></span>
  </td>
<tr>
    ...
    <td ><?php echo $form->labelEx($model, 'identity_num'); ?></td>
    <td >
    <span class="label-box"><?php echo $model->qualifications_person->qualification_code;?></span>
    </td>
    </tr>     
 ...
 <?php echo $form->hiddenField($model, 'qualification_pic',array('class' => 'input-text','value'=>'')); ?>
        ...
        <div class="mt15">
            ...
            <!-- <table>
                <tr>
                    <td width="15%"><? php echo $form->labelEx($model, 'check_state'); ?></td>
                    <td width="35%">
                        <? php echo $form->radioButtonList($model, 'check_state', Chtml::listData(BaseCode::model()->getShenheState(), 'f_id', 'F_NAME'), $htmlOptions = array('separator' => '', 'class' => 'input-check', 'template' => '<span class="check">{input}{label}</span>')); ?>
                        <?php echo $form->error($model, 'check_state'); ?>
                    </td>
...
$('#account_select_btn').on('click', function(){ 
    ...
    close: function () {
        ...
        $('#gfaccount_show').html('<span class="label-box">'+$.dialog.data('gfaccount')+'</span>');
        $('#ClubQualificationPerson_gfaccount').val($.dialog.data('gfaccount'));
