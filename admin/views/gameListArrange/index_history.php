    ...
    <div class="box-content">
        <div class="box-detail-tab">
            <ul class="c">
                ...
                <li><a href="<?php echo $this->createUrl('gameSignList/index_history',array('game_id'=>$_REQUEST['game_id'],'p_id'=>$_REQUEST['p_id'])); ?>">赛事成员</a></li>
                <li class="current"><a href="#">赛事赛程</a></li>
                <li><a href="#">赛事成绩</a></li>
            </ul>
        </div>
        <div>
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:20px;">
                    <span>关键字：</span>
                    <input style="width:200px;" class="input-text" type="text" id="keywords" name="keywords" value="<?php echo Yii::app()->request->getParam('keywords');?>" placeholder="请输入赛程编码或名称/签号">
                </label>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('arrange_tname');?></th>
                ...
                <tbody>
                    <?php $index = 1; foreach($arclist as $v){?>
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo $v->arrange_tname; ?></td>
                            <td style="text-align: center;"><?php echo $v->game_site; ?></td>
                            <td style="text-align: center;"><?php echo $v->star_time.'<br>'.$v->end_time; ?></td>
