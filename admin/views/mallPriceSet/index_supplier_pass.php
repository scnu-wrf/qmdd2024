...
<div class="box">
    <div class="box-title c">
        <h1>当前界面：商城》商品上架》<a class="nav-a">商品上架审核</a></h1>
        <span class="back"><a class="btn" href="javascript:;" onclick="we.reload();"><i class="fa fa-refresh"></i>刷新</a></span>
    </div><!--box-title end-->
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="<?php echo $this->createUrl('mallPriceSet/index_supplier_check');?>">待审核(<span class="red"><b><?php echo $num; ?></b></span>)</a>
        </div><!--box-header end-->
...
if(is_array($arclist)) foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('update_supplier_check', array('id'=>$v->id,'flag'=>'pass'));?>" title="详情">查看</a>
                        </td>
                    </tr>
                   <?php $index++; } ?>
                </table>
