...
<div class="box">
    <div class="box-title c">
        <h1>当前界面：商城》GF商城上下架管理》商品上架审核》<a class="nav-a">待审核</a></h1>
        ...
        <div class="box-table">
            <table class="list">
                    <tr class="table-title">
                        ...
                        <th style="width:70px;"><?php echo $model->getAttributeLabel('apply_time');?></th>
...
if(is_array($arclist)) foreach($arclist as $v){ ?>
                ...
                <?php $sale=MallPriceSetDetails::model()->findAll('set_id='.$v->id.' AND flash_sale=0');
                    ...
                    if($sale_num>3){
                        ...
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('update_check', array('id'=>$v->id,'flag'=>'pass'));?>" title="详情">审核</a>
                        </td>
                    </tr>
                   <?php $index++; } ?>
                </table>
