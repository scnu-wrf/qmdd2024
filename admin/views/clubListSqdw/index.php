<div class="box">
    ...
    <h1><?php if($_REQUEST['index']==1){echo '当前界面：社区单位 》意向入驻管理》意向入驻审核';}elseif($_REQUEST['index']==2){echo '当前界面：社区单位 》意向入驻管理》意向入驻审核 》待审核';}elseif($_REQUEST['index']==3){echo '当前界面：社区单位 》意向入驻管理》审核未通过';}elseif($_REQUEST['index']==4){echo '当前界面：社区单位 》意向入驻管理》意向入驻列表';}elseif($_REQUEST['index']==5){echo '当前界面：社区单位 》意向入驻管理》意向待审核';};?></h1></div><!--box-title end-->
