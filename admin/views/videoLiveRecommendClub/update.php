        ...
        <div class="box-detail-bd">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3"><span id="club_box" class="label-box"><?php echo $model->club_name; ?></span>
                    <?php echo $form->hiddenField($model, 'club_id', array('class' => 'input-text')); ?><input id="club_select_btn" class="btn" type="button" value="选择">
                    <?php echo $form->error($model, 'club_id', $htmlOptions = array()); ?></td>
                </tr>
                <tr>
                    <td><?php echo $form->labelEx($model, 'club_list'); ?></td>
                    <td colspan="3"><?php echo $form->hiddenField($model, 'club_list', array('class' => 'input-text')); ?>
...
// 选择单位
    ...
    var $club_id=$('#VideoLiveRecommendClub_club_id');
...
var $VideoLive_club_list=$('#VideoLiveRecommendClub_club_list');
