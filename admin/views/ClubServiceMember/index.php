        ...
        <div class="box-table">
            ...
            <table class="list">
                ...
                <tbody>
					...
					<?php 
						$sql="select u.ZSXM as admin_name,q.admin_gfaccount,q.admin_gfnick,q.last_login from userlist u,qmdd_administrators q where q.id=".$v->admin_id." and q.admin_gfid=u.GF_ID";
