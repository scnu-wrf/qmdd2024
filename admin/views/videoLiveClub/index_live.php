...
<div class="box">
    <div class="box-title c">
        <h1>当前界面：直播》直播单位》<a class="nav-a">直播单位列表</a></h1>
        <span class="back"><a class="btn" href="<?php echo $this->createUrl('index_live');?>"><i class="fa fa-refresh"></i>刷新</a></span>
    </div><!--box-title end--> 
 ...
 <?php   $index = 1;
	foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td>
                        	<a class="btn" href="<?php echo $this->createUrl('update_checked', array('id'=>$v->id,'flag'=>'live'));?>" title="详情">查看</a>
                        </td>
                    </tr>
<?php  $index++; } ?>
                </table>
