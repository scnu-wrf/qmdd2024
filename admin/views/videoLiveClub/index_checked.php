...
<div class="box">
    <div class="box-title c">
        <h1>当前界面：直播》直播单位》直播单位审核》<a class="nav-a">待审核</a></h1>
        <span class="back"><a class="btn" href="<?php echo $this->createUrl('index_checked');?>"><i class="fa fa-refresh"></i>刷新</a></span>
    </div><!--box-title end--> 
 ...
 <?php   $index = 1;
	foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td>
                        	<a class="btn" href="<?php echo $this->createUrl('update_checked', array('id'=>$v->id,'flag'=>'checked'));?>" title="详情">审核</a>
                        </td>
                    </tr>
<?php  $index++; } ?>
                </table>
