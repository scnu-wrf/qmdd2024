    ...
    <div class="box-content">
        <div class="box-detail-tab">
            <ul class="c">
                ...
                <li class="current"><a href="#">赛事裁判</a></li>
                ...
                <tbody>
                    <?php $index = 1; foreach($arclist as $v){?>
                        <tr>
                            ...
                            <td style='text-align: center;'><?php if(!empty($v->sign_game_data_id))echo $v->game_list_data->game_data_name; ?></td>
