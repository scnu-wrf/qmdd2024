...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>文章列表</h1></div><!--box-title end-->
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="<?php echo $this->createUrl('create', array('p_id'=>NULL));?>"><i class="fa fa-plus"></i>添加</a>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('cat_id');?></th>
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('is_open');?></th>
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('add_time');?></th>
                        <th style='text-align: center;'>操作</th>
                    </tr>
                </thead>
                <tbody>
<?php $basepath=BasePath::model()->getPath(192);?>
<?php 
$index = 1;
...
?>
                    <tr>
                        ...
                        <!--<td><?php if($v->cat_id!=null){ echo $v->gf_article->cat_name; } ?></td>-->
                        <!--<td style='text-align: center;'><?php if($v->auto_filter_set!=null){ echo $v->auto_filter_set->name; } ?></td>-->
