    ...
    <div class="box-content"> 
          ...
          <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                        <span>关键字：</span>
                        <input style="width:200px;" class="input-text"  placeholder="商品编号/名称/订单号/商家名称" type="text" name="keywords" value="<?php echo Yii::app()->request->getParam('keywords');?>">
                </label>
            ...
            <table class="list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('mallSalesOrderInfo/update_gf', array('id'=>$v->info_id));?>" title="详情">查看</a>
                        </td>
                    </tr>
					<?php $index++; } ?>
                </tbody>
