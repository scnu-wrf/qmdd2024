    ...
    <div class="box-detail">
        ...
        <div class="box-detail-bd">
            <div style="display:block;" class="box-detail-tab-item">
                <?php echo $form->hiddenField($model, 'set_id', array('class' => 'input-text','value' =>$_REQUEST['pid'])); ?>
                <?php echo $form->hiddenField($model, 'type', array('class' => 'input-text','value' =>$_REQUEST['ptype'])); ?>
