<div class="box">
    ...
    <div class="box-detail-tab box-detail-tab-green mt15">
        <ul class="c">
            ...
            <li<?php if($action=='doc'){?> class="current"<?php }?>><a href="<?php echo $this->createUrl('gfMaterial/doc');?>">电子书</a></li>
    ...
    <div class="material c">
        <div class="material-lt">
            <div class="material-hd c">
                <div class="material-hd-lt">全部</div>
                <div class="material-hd-rt">
                    <div class="material-upload"><script>var materialDocUrl='<?php echo $this->createUrl('gfMaterial/updoc', array('group_id'=>$group_id));?>';we.materialDoc();</script></div>
                    <span class="msg">格式支持TXT，文件大小不超过50M</span>
                </div>
            </div><!--material-hd end-->
            <div class="material-bar c">
                ...
                <a class="btn" href="<?php echo $this->createUrl('docCreate');?>"><i class="fa fa-plus"></i>添加</a>
            </div><!--material-bar end-->
            <div class="material-video c">
                <ul id="material-main" class="c">
                    <?php foreach($arclist as $v){ ?>
                    <li>
                        <div class="pic"><a href="<?php echo $v->v_file_path;?><?php echo $v->v_name;?>" target="_blank"><img src="<?php echo SITE_PATH;?>/static/admin/img/i_doc.jpg"></a></div>
                        <div class="title">
                        ...
                        <div class="bar">
                            ...
                            <a class="fa fa-bars" href="<?php echo $this->createUrl('docUpdate', array('id'=>$v->id));?>"></a>
        ...
        <div class="material-rt">
            <div class="material-group">
                <a<?php if($group_id==0){?> class="current"<?php }?> href="<?php echo $this->createUrl('gfMaterial/'.$action);?>">全部电子书<span>(<?php echo $all_num;?>)</span></a>
                ...
                <a<?php if($group_id==$v->id){?> class="current"<?php }?> href="<?php echo $this->createUrl('gfMaterial/'.$action, array('group_id'=>$v->id));?>"><?php echo $v->group_name;?><span>(<?php echo GfMaterial::model()->getNum($v->id,779);?>)</span><span class="hidden_del" onclick="fnDeleteGroup(<?php echo $v->id;?>);"></span></a>
                <?php } ?>
            </div>
...
//删除分组
var fnDeleteGroup=function(group_id){
	$.ajax({
        type:'POST',
...
var fnAddGroup=function(){
    ...
    $.ajax({
        type:'POST',
        url:'<?php echo $this->createUrl('addGroup',array('m_type'=>779));?>',
...
var fnChangeGroupShow=function(id,op){
    ...
    $.ajax({
         type:'GET',
         url:'<?php echo $this->createUrl('getGroup',array('m_type'=>779));?>',
         dataType:'html',
         success:function(data){
