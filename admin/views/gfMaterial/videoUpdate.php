<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>编辑视频素材</h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span></div><!--box-title end-->
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <?php if($model->v_pic!=''){
						$str=substr($model->v_pic,0,6); ?>
                        <?php if($str=='record') {
							$pic_path=$model->v_file_path;
						} else {
							$pic_path=$basepath->F_WWWPATH;} ?>
                        <div class="upload_img fl" id="upload_pic_<?php echo get_class($model);?>_v_pic"><a href="<?php echo $pic_path.$model->v_pic;?>" target="_blank"><img src="<?php echo $pic_path.$model->v_pic;?>" width="100"></a></div><?php }?>
            ...
            <tr>
                ...
                <td>
                    <?php echo $form->textField($model, 'v_file_path', array('class' => 'input-text')); ?>
