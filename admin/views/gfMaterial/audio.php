    ...
    <div class="material c">
        ...
        <div class="material-rt">
            <div class="material-group">
                ...
                <a<?php if($group_id==$v->id){?> class="current"<?php }?> href="<?php echo $this->createUrl('gfMaterial/'.$action, array('group_id'=>$v->id));?>"><?php echo $v->group_name;?><span>(<?php echo GfMaterial::model()->getNum($v->id,254);?>)</span><span class="hidden_del" onclick="fnDeleteGroup(<?php echo $v->id;?>);"></span></a>
                <?php } ?>
            </div>
...
var fnAddGroup=function(){
    ...
    $.ajax({
        type:'POST',
        url:'<?php echo $this->createUrl('addGroup',array('m_type'=>254));?>',
...
var fnChangeGroupShow=function(id,op){
    ...
    $.ajax({
         type:'GET',
         url:'<?php echo $this->createUrl('getGroup',array('m_type'=>254));?>',
         dataType:'html',
         success:function(data){
