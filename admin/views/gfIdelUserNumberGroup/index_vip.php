...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>VIP号码列表</h1></div><!--box-title end-->
            ...
            <table class="list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style='text-align: center;'><?php echo GfIdelUserAllNumber::model()->count('group_id='.$v->id .' and f_vip=1 and is_use=1'); ?></td>
                        <td style='text-align: center;'><?php echo $v->create_time; ?></td>
                        <td style='text-align: center;'>
                            <a class="btn" href="<?php echo $this->createUrl('detail_vip', array('id'=>$v->id));?>">详情</a>
                        </td>
                    </tr>
					<?php $index++; } ?>
                </tbody>
