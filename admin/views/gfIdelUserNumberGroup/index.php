...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>号码列表</h1></div><!--box-title end-->
    <div class="box-content">
        <div class="box-header">
			<a class="btn" href="../qmdd2018/index.php?r=gfIdelUserAllNumber/create"><i class="fa fa-plus"></i>添加</a>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('is_category');?></th>
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('nomal_count');?></th>
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('vip_count');?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style='text-align: center;'><?php echo ($v->is_category==649) ? '已分类' : '待分类'; ?></td>
                        <td style='text-align: center;'><?php echo $v->nomal_count; ?></td>
                        <td style='text-align: center;'><?php echo $v->vip_count; ?></td>
                        <td style='text-align: center;'><?php echo $v->create_time; ?></td>
                        <td style='text-align: center;'>
                            <a class="btn" href="<?php echo $this->createUrl('detail', array('id'=>$v->id));?>">详情</a>
							<a class="btn" href="<?php echo $this->createUrl('sorting', array('id'=>$v->id));?>">分类</a>
                        </td>
                    </tr>
					<?php $index++; } ?>
                </tbody>
