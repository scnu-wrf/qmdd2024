<div class="box">
    <div class="box-title c">
        <h1>当前界面：社区单位》场馆管理》<a class="nav-a">场馆入驻</a></h1>
...
<script>
    var deleteUrl = '<?php echo $this->createUrl('testStadium/Delete', array('id'=>'ID'));?>';
</script>
<script>
    function tijiao(modelid) {
        $.ajax({
            type: 'get',
            url: "<?php echo $this->createUrl('testStadium/Tijiao');?>",
            data: {
                modelid:modelid
            },
            dataType: 'json',
