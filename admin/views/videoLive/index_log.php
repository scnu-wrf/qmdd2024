<div class="box">
    <div class="box-title c">
        <h1>当前界面：直播》直播管理》<a class="nav-a">历史直播列表</a></h1>
        <span class="back"><a class="btn" href="<?php echo $this->createUrl('index_log');?>"><i class="fa fa-refresh"></i>刷新</a></span>
    </div><!--box-title end--> 
    <div class="box-content">
        <div class="box-search" style="border:none;">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:20px;">
                    <span>状态：</span>
                    <select name="is_uplist">
                        <option value="">请选择</option>
                        <option value="1"<?php if(Yii::app()->request->getParam('is_uplist')!==null && Yii::app()->request->getParam('is_uplist')!=='' && Yii::app()->request->getParam('is_uplist')==1){?> selected<?php }?>>上线</option>
                        <option value="0"<?php if(Yii::app()->request->getParam('is_uplist')!==null && Yii::app()->request->getParam('is_uplist')!==''  && Yii::app()->request->getParam('is_uplist')==0){?> selected<?php }?>>下线</option>
                    </select>
                </label>
