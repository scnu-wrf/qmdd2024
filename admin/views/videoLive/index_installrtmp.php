<div class="box">
    <div class="box-title c">
        <h1>当前界面：直播》监管/监控》推流地址管理》<a class="nav-a">待配置</a></h1>
        <span class="back"><a class="btn" href="<?php echo $this->createUrl('videoLive/index_rtmp');?>"><i class="fa fa-reply"></i>返回上一层</a> <a class="btn" href="javascript:;" onclick="we.reload();"><i class="fa fa-refresh"></i>刷新</a></span>
    </div><!--box-title end--> 
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th width="15%"><?php echo $model->getAttributeLabel('code');?></th>
                        <th><?php echo $model->getAttributeLabel('title');?></th>
                        <th><?php echo $model->getAttributeLabel('live_type');?></th>
                        <th style="width:120px;">直播节目起止时间</th>
                        <th>状态</th>
                        <th>操作</th>
                    </tr>
                </thead>
 ...
 foreach($arclist as $v){ ?>
    <?php $live_num=VideoLivePrograms::model()->count('live_id=' . $v->id); ?>
                    <tr>
                        ...
                        <td><?php echo (!empty($v->live_source_RTMP)) ? '已配置' : '待配置'; ?></td>
                        <td>
