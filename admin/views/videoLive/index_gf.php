<div class="box">
    <div class="box-title c">
        <h1>当前界面：直播》各单位直播查询》<a class="nav-a">各单位历史直播列表</a></h1>
        <span class="back"><a class="btn" href="<?php echo $this->createUrl('index_gf');?>"><i class="fa fa-refresh"></i>刷新</a></span>
    </div><!--box-title end-->
...
<?php  $index = 1;
 foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td style="width:15%;"><?php echo $v->title; ?></td>
