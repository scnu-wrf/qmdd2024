    ...
    <?php  $form = $this->beginWidget('CActiveForm', get_form_list()); ?>
        ...
        <div class="box-detail-bd">
			...
			<table class="mt15" id="t7" style="table-layout:auto;">
                <?php if($model->live_state!=136){?>
                    <tr>
                        <td width='10%'>审核备注</td>
                        <td width='90%' colspan="3">
                            <?php 
                            if($model->live_state==371){
                                echo $form->textArea($model, 'live_state_reasons_failure', array('class' => 'input-text')); 
                            }else{
                                echo $form->textArea($model, 'live_state_reasons_failure', array('class' => 'input-text','readonly'=>'readonly')); 
                            }
                            ?>
                            <?php echo $form->error($model, 'live_state_reasons_failure', $htmlOptions = array()); ?>
                        </td>
                    </tr>
                <?php }?>
                <tr>
