                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo $this->createUrl('videoLiveSignSetting/index',array('video_live_id'=>$v->id,'return_state'=>1)); ?>" class="btn">打赏对象</a>
                            <a href="javascript:;" class="btn" onclick="rewardUp('<?php echo $v->id;?>');">下架</a>
...
<script>
    ...
    function updateState(id){
        $.ajax({
            type: "get",
            url:'<?php echo $this->createUrl("reward/down");?>&id='+id,
            dataType:"json",
