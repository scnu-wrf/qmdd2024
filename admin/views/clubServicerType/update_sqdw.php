...
<div class="box">
    <div class="box-title c">
        <h1>
          <span>
          当前界面：社区单位》社区单位设置 》社区单位类型设置 》<?=empty($model->f_id)?'添加':'编辑';?>
          </span>
        </h1>
            ...
            <div style="display:block;" class="box-detail-tab-item">
                <table width="100%" style="table-layout:auto;">
                    <tr class="table-title">
                        ...
                        <?php echo $form->hiddenField($model, 'type', array('class' => 'input-text','value' => 1467)); ?>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="font-size:14px;">
                            <?php 
                                ...
                                echo $form->checkBoxList($model, 'entry_way', Chtml::listData(BaseCode::model()->getApproveState(), 'f_id', 'F_SHORTNAME'),$htmlOptions = array('separator' => '', 'class' => 'input-check', 'template' => '<span class="check">{input}{label}</span>'));
                            ?>
                ...
                <table width="100%" style="table-layout:auto; margin-top:10px; ">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><?php echo $form->radioButtonList($model, 'rely_on_community_number', array(0 => '1个项目挂靠1个社区单位', 1 => '1个项目挂靠多个社区单位'), $htmlOptions = array('separator' => '', 'class' => 'input-check', 'template' => '<span class="check">{input}{label}</span>')); ?>
                        <?php echo $form->error($model, 'rely_on_community_number'); ?></td>
                    </tr>
                </table>
                <table style="table-layout:auto; margin-top:10px; ">
                    <tr class="table-title">
                        <td colspan="4">社区单位学员设置</td>
                    </tr>
                    <tr>
