...
<div class="box">
    <div class="box-title c">
        <h1>
          <span>
          当前界面：会员 》龙虎会员管理 》龙虎会员类型设置 》<?=empty($model->f_id)?'添加':'编辑';?>
          </span>
        </h1>
            ...
            <div style="display:block;" class="box-detail-tab-item">
                <table width="100%" style="table-layout:auto;">
                    <tr class="table-title">
                        ...
                        <?php echo $form->hiddenField($model, 'type', array('class' => 'input-text','value' => 1472)); ?>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><?php echo $form->labelEx($model, 'get_type'); ?></td>
                        <td width="32%" colspan="3">
                            <?php 
                                $model->get_type=explode(',',$model->get_type); 
                                echo $form->checkBoxList($model, 'get_type', Chtml::listData(BaseCode::model()->getCode(892), 'f_id', 'F_NAME'),$htmlOptions = array('separator' => '', 'class' => 'input-check', 'template' => '<span class="check">{input}{label}</span>'));
                            ?>
                            <?php echo $form->error($model, 'get_type', $htmlOptions = array()); ?>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
