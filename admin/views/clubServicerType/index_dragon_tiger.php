...
<div class="box">
    <div class="box-title c">
        <h1> <span>当前界面：会员 》龙虎会员管理 》龙虎会员类型设置</span> </h1>
      ...
      <table class="list" style="text-align:left;">
        <thead>
          <tr>
            ...
            <th width="103"><?php echo $model->getAttributeLabel('get_type');?></th>
            <th width="146">操作</th>
          </tr>
        </thead>
        <tbody>   
            ...
            <tr>
                ...
                <td width="200px">
                    <?php echo show_command('修改',$this->createUrl('update_dragon_tiger', array('id'=>$v->f_id))); ?>
