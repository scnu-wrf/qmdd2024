...
<div class="box">
    <div class="box-title c">
        <h1> <span>当前界面：社区单位 》社区单位设置 》社区单位类型设置</span> </h1>
    ...
    <div class="box-content"> 
        <div class="box-header"> 
            <a class="btn" href="<?php echo $this->createUrl('create_sqdw');?>"><i class="fa fa-plus"></i>添加</a> 
      ...
      <table class="list" style="text-align:left;">
        ...
        <tbody>   
            ...
            <tr>
                ...
                <td width="200px">
                    <?php echo show_command('修改',$this->createUrl('update_sqdw', array('id'=>$v->f_id))); ?>
