...
<div class="box">
    <div class="box-title c">
        <h1><span>当前界面：分销商 》分销商设置 》供应商类型</span></h1>
    ...
    <div class="box-content"> 
        <div class="box-header"> 
            <a class="btn" href="<?php echo $this->createUrl('create_fxs');?>"><i class="fa fa-plus"></i>添加</a> 
      ...
      <table class="list" style="text-align:left;">
        ...
        <tbody>   
            ...
            <tr>
                ...
                <td width="200px">
                    <?php echo show_command('修改',$this->createUrl('update_fxs', array('id'=>$v->f_id))); ?>
