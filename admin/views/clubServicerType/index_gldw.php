...
<div class="box">
    <div class="box-title c">
        <h1> <span>当前界面：首页 》管理机构 》管理类型设置</span> </h1>
    ...
    <div class="box-content"> 
        <div class="box-header"> 
            <a class="btn" href="<?php echo $this->createUrl('create_gldw');?>"><i class="fa fa-plus"></i>添加</a> 
      ...
      <table class="list" style="text-align:left;">
        <thead>
          <tr>
            ...
            <th>序号</th>
            <th><?php echo $model->getAttributeLabel('member_type_code');?></th>
            <th><?php echo $model->getAttributeLabel('member_second_code');?></th>
            <th><?php echo $model->getAttributeLabel('if_project');?></th>
            <th><?php echo $model->getAttributeLabel('entry_way');?></th>
            <th><?php echo $model->getAttributeLabel('renew_time');?></th>
            <th><?php echo $model->getAttributeLabel('renew_notice_time');?></th>
            <th><?php echo $model->getAttributeLabel('is_show');?></th>
            <th>操作</th>
          </tr>
        </thead>
        <tbody>   
            ...
            <tr>
                ...
                <td width="200px">
                    <?php echo show_command('修改',$this->createUrl('update_gldw', array('id'=>$v->f_id))); ?>
