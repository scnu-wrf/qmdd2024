...
<div class="box">
    <div class="box-title c">
        <h1> <span>当前界面：服务者 》服务者设置 》服务类型设置</span> </h1>
      ...
      <table class="list" style="text-align:left;">
        <thead>
          <tr>
            ...
            <th width="140"><?php echo $model->getAttributeLabel('code');?></th>
            ...
            <th width="103"><?php echo $model->getAttributeLabel('certificate_type');?></th>
            <th width="146">操作</th>
          </tr>
        </thead>
        <tbody>   
            ...
            <tr>
                ...
                <td width="200px">
                    <?php echo show_command('修改',$this->createUrl('update', array('id'=>$v->f_id))); ?>
