...
<div class="box">
    <div class="box-title c">
        <h1><span>当前界面：供应商 》供应商设置 》供应商设置</span></h1>
    ...
    <div class="box-content"> 
        <div class="box-header"> 
            <a class="btn" href="<?php echo $this->createUrl('create_gys');?>"><i class="fa fa-plus"></i>添加</a> 
      ...
      <table class="list" style="text-align:left;">
        ...
        <tbody>   
            ...
            <tr>
                ...
                <td width="200px">
                    <?php echo show_command('修改',$this->createUrl('update_gys', array('id'=>$v->f_id))); ?>
