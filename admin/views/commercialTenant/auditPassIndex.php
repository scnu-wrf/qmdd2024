    ...
    function sub(){
            ...
            $.ajax({
                ...
                success: function(response) {
                    // 处理成功的响应
                      window.location.href = '/sports/admin/qmdd2018/index.php?r=commercialTenant/auditPassIndex';
                },
...
<div class="box">
    <div class="box-title c">
        <h1><?php if(empty($_REQUEST['edit_state'])){echo '当前界面：商户管理 》商户入驻 》已过审商户';}else{echo '当前界面：社区单位》单位认证管理 》单位认证申请';};?></h1>
...
<form action="/sports/admin/qmdd2018/index.php?r=commercialTenant/auditPassIndex" ><p>
<input type="hidden" name="r" value="commercialTenant/auditPassIndex" >
            ...
            <table class="list">
                <thead>
                    ...
                    <tr>
                        ...
                        onclick="location.href='/sports/admin/qmdd2018/index.php?r=commercialTenant/auditEnterprise&id=<?php echo $arc->id;?>&mode=0&from=1'" style="background-color:#368ee0;color:white;">审核</button>
