...
<div class="box">
    <div class="box-title c">
        <h1>
            当前界面：系统 》积分/体育豆 》消费置换积分确认<?php echo !empty($_REQUEST['state'])?' 》待确认':'';?>
        </h1>
            ...
            <thead>
                <table class="list">
                    <tr>
                        ...
                        <th>序号</th>
                        <th><?php echo $model->getAttributeLabel('get_id');?></th>
                        <th>消费者</th>
                        <th><?php echo $model->getAttributeLabel('item_code');?></th>
                        <th>消费金额</th>
                    ...
                    <?php $index = 1; foreach($arclist as $v){ ?>
                        <tr>
                            ...
                            <td><?php echo $v->get_account;?></td>
                            <td><?php echo $v->get_nicename;?></td>
                            <td><?php echo $v->got_credit_reson; ?></td>
                            <td><?php if(!empty($v->ordernum))echo $v->ordernum->total_money; ?></td>
                            <td><?php if(!empty($v->ordernum))echo $v->ordernum->pay_time; ?></td>
