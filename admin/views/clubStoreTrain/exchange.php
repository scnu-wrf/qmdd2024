...
<?php foreach($arclist as $v){ ?>
                    <tr data-id="<?php echo $v->id; ?>">
                        <td width="70%"><?php echo $v->train_code;?></td>
                        <td width="70%"><?php echo $v->train_title;?></td>
                    </tr>
<?php } ?>
                </tbody>
            </table>
...
<script>
var arclist=<?php echo json_encode(toArray($arclist,'id,train_title,video_live_id'));?>
</script>
<script>
$(function(){
