    ...
    <div class="box-content">
        <div class="box-detail-tab mt15">
            <ul class="c">
                ...
                <li><a href="<?=$this->createUrl('clubQualificationPerson/index_thawy')?>">解冻</a></li>
            </ul>
        </div>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th>操作内容</th>
                        <th><?php echo $model->getAttributeLabel('qualification_gf_code');?></th>
                ...
                <?php $index = 1;foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td><?php echo $v->qualifications_person->qualification_gf_code; ?></td>
                        <td><?php echo $v->qualifications_person->qualification_gfaccount; ?></td>
                        <td><?php echo $v->qualifications_person->qualification_name; ?></td>
                        <td><?php echo $v->qualifications_person->qualification_project_name; ?></td>
                        <td><?php echo $v->qualifications_person->qualification_type; ?></td>
                        ...
                        <td><?php echo $v->process_preson_nick; ?></td>
                    </tr>
                <?php $index++;} ?>
                </tbody>
            </table>
    ...
    close: function () {
        if($.dialog.data('gfid')>0){
            ...
            '<tr style="text-align:center;" class="add_len">'+
                ...
                '<td style="border:solid 1px #d9d9d9;padding:5px;">'+e.qualification_gf_code+'</td>'+
                '<td style="border:solid 1px #d9d9d9;padding:5px;">'+e.qualification_gfaccount+'</td>'+
                '<td style="border:solid 1px #d9d9d9;padding:5px;">'+e.qualification_name+'</td>'+
                '<td style="border:solid 1px #d9d9d9;padding:5px;">'+e.qualification_project_name+'</td>'+
