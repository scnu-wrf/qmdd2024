<div class="box">
    <div class="box-title c">
        <h1>当前界面：财务》发票管理》开票管理》<a class="nav-a">详情</a></h1>
    ...
    <div class="box-detail">
     <?php  $form = $this->beginWidget('CActiveForm', get_form_list());
      ?>
        ...
        <table>
<?php $o_data=MallSalesOrderData::model()->find('invoice_data_id='.$model->id.' and orter_item=757'); ?>
<?php $logistics=OrderInfoLogistics::model()->find('id='.$o_data->logistics_id); ?>
        ...
        <table style="table-layout:auto;">
            ...
            <script>we.uploadpic('<?php echo get_class($model);?>_electronics_images', '<?php echo $picprefix;?>');</script>
                ...
                <td>可执行操作</td>
                <td colspan="3">
                <a class="btn" onClick="fnCancel(<?php echo $model->id;?>);" href="javascript:;">收回发票</a>
...
<script>
selectComPer($('#InvoiceRequestListData_company_personer'));
...
selectCategory($('#InvoiceRequestListData_company_personer'));
