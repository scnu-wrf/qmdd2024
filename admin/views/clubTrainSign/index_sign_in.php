...
<div class="box">
    <div class="box-title c">
        <h1>当前界面：培训/活动 》培训签到 》签到列表<?= $title;?></h1>
        <span class="back">
            ...
            <div class="box-search">
                <?php if($_REQUEST['is_sign']==1){ ?>
                    ...
                    <span style="float:right;font-weight:700;margin-right:10px;">
                        <span class="btn">培训报名数：<b class="red"><?php echo $num; ?></b></span><span class="btn">待签到：<b class="red"><?php echo $count1; ?></b></span>
                    </span>
            ...
            <table class="list">
                ...
                <?php $index = 1; foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td><?php if(!is_null($v->train_sign))echo $v->train_sign->sign_name.'('.$v->gf_account.')'; ?></td>
                        <td><?php if(!is_null($v->train_sign))echo $v->train_sign->sige_phone; ?></td>
                        <td>
                            <?php 
