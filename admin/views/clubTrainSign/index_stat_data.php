<div class="box">
    <div class="box-title c">
        <h1>
            <?php 
                if($_REQUEST['index']==1){
                    echo '当前界面：培训/活动 》培训结算 》培训结算统计 》结算明细';
                }elseif($_REQUEST['index']==2){
                    echo '当前界面：财务 》培训结算统计 》结算明细';
                }
            ?>
        </h1>
        <span class="back">
    ...
    <div class="box-content">
        <div class="box-detail-tab" style="margin-top:10px;">
            <ul class="c">
                <li style="padding:0 10px;"><a href="<?php echo $this->createUrl('clubStoreTrain/index_stat',array('index'=>$_REQUEST['index']));?>">培训结算统计</a></li>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php if(!is_null($v->train_sign))echo $v->train_sign->sign_name.'('.$v->train_sign->sign_account.')'; ?></td>
