...
<div class="box">
    <div class="box-title c"><h1>当前界面：培训/活动 》培训评价 》评价列表 》详情</h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span></div><!--box-title end-->
                    ...
                    <td>
                        ...
                        <?php
                            if(!isset($model->club_f_mark)||$model->club_f_mark==0){
                                ...
                                echo '<span class="club_f_mark">★</span><span class="club_f_mark">★</span><span class="club_f_mark">★</span class="club_f_mark"><span class="club_f_mark">★</span><span class="club_f_mark">☆</span>';
