                ...
                <tbody>
                    <?php $index = 1; foreach($arclist as $v){ ?>
                        <tr>
                            ...
                            <td><?php if(!is_null($v->user)&&$v->user->id_card_type==843)echo substr_replace($v->user->id_card,'**********',6,10); ?></td>
                            ...
                            <td><?php echo $v->state==2?'报名成功':'取消报名'; ?></td>
                            <td>
        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data,function(k,info){
                    content+='<option value="'+info.id+'" remnant="'+info.remnant+'" >'+info.activity_content+'</option>'
                })
                $("select[name='content']").html(content);
            }
        });
