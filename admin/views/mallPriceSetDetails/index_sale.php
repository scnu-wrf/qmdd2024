<div class="box">
    <div class="box-title c">
        <h1>当前界面：商城》商品上架》<a class="nav-a">在售商品列表</a></h1>
...
if (is_array($arclist)) foreach($arclist as $v){ ?>
                    ...
                    <?php $record=MallPricingDetails::model()->find('(set_details_id='.$v->id.') order by id DESC'); ?>
                        ...
                        <td><?php if(!empty($v->mall_price_set)){ $if_user_state=array(648=>'下线', 649=>'上线'); echo $if_user_state[$v->mall_price_set->if_user_state]; } ?></td>
                        <td>
