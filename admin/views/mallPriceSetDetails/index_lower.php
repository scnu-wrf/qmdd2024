<div class="box">
    <div class="box-title c">
        <h1>当前界面：商城》GF商城上下架管理》<a class="nav-a">下架商品列表</a></h1>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $model->getAttributeLabel('sale_id');?></th>
                        <th>上架/库存数量</th>
                        <th><?php echo $model->getAttributeLabel('up_available_quantity');?></th>
                        <th><?php echo $model->getAttributeLabel('start_sale_time');?></th>
                        <th>下架数量</th>
                        <th>下架时间</th>
                    </tr>
                </thead>
...
if (is_array($arclist)) foreach($arclist as $v){ ?>
                    ...
                    <?php $record=MallPricingDetails::model()->find('(set_details_id='.$v->id.') order by id DESC'); ?>
                        ...
                        <td><?php echo $v->up_quantity; ?>/<?php echo $v->up_quantity-$v->up_available_quantity; ?></td>
                        <td><?php echo $v->up_available_quantity; ?></td>
