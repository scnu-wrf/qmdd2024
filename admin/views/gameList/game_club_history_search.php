<div class="box">
	...
	<div class="box-detail-tab">
		<ul class="c">
			...
			<li><a href="<?php echo $this->createUrl('game_club_search');?>">已发布</a></li>
			<li class="current"><a href="javascript:;">历史赛事</a></li>
		</ul>
	</div>
                    ...
                    <?php $index = 1; foreach($arclist as $v){ ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn" href="<?php echo $this->createUrl('gameListArrange/list', array('game_id'=>$v->id,'back'=>4)); ?>" title="赛程">赛程</a>
                                <a class="btn" href="<?php echo $this->createUrl('GameSignList/index_exam', array('game_id'=>$v->id,'back'=>4)); ?>" title="报名">报名</a>
                                <a class="btn" href="<?php echo $this->createUrl('gfServiceData/signin_game_index', array('game_id'=>$v->id,'back'=>4)); ?>" title="签到">签到</a>
                                <a class="btn" href="<?php echo $this->createUrl('gameListArrange/index_results1', array('game_id'=>$v->id,'back'=>4)); ?>" title="成绩">成绩</a>
                            </td>
                        </tr>
                    <?php $index++; } ?>
                </tbody>
