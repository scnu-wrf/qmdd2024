    ...
    <div id="t0" class="box-title c">
        <span>
            ...
            <?php if(!empty($model->id)) {?>
                -> <a href="<?php echo $this->createUrl('gameList/update',array('id'=>$model->id)); ?>" class="lode_po"><?php echo $model->game_title; ?></a> -> 裁判员报名须知
            <?php }?>
        </span>
        ...
        <?php if($model->id!=''){?>
            <div class="box-detail-tab">
                <ul class="c">
                    ...
                    <li><a href="<?php echo $this->createUrl('gameList/member_notice',array('id'=>$model->id)); ?>">运动员报名须知</a></li>
                    <li class="current"><a href="<?php echo $this->createUrl('gameList/team_notice',array('id'=>$model->id)); ?>">裁判员报名须知</a></li>
                </ul>
