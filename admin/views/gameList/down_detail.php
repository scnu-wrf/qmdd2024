<div class="box">
    <div class="box-title c"><h1>当前界面：视频》视频管理》下架视频列表》<a class="nav-a">详情</a></h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回上一层</a></span></div><!--box-title end-->
        ...
        <div class="box-detail-bd">
			...
			<table>
				<tr>
					...
					<td width="35%" style="color:#7a7a7a"><?php echo $model->program_num;?></td>
				...
				<tr>
					...
					<td width="35%" style="color:#7a7a7a"><?php echo $model->area;?></td>
				...
				<tr>
					...
					<td colspan="3" style="color:#7a7a7a"><?php echo $model->video_intro;?><?php echo $form->hiddenField($model, 'video_intro', array('class' => 'input-text')); ?></td>
				</tr>
			</table>
					...
					<td>
						...
						<table id="program_list" class="showinfo" data-num="new" style="margin:0;table-layout:auto;">
							<tr class="table-title">
								...
								<td>分集号<span class="required">*</span></td>
			...
			<table>
				<tr>
					<td width="15%">状态</td>
					<td colspan="3" style="color:#7a7a7a"><?php echo $model->down_type==1?'单位下架':($model->down_type==3?'违规下架':'过期下架'); ?></td>
				</tr>
				<tr>
					<td>下架员</td>
					<td colspan="3" style="color:#7a7a7a">
						<?php echo $model->down_admin_nick;?>
					</td>
				</tr>
			</table>
