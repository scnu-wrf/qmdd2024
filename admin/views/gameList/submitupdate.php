<div class="box">
    <div id="t0" class="box-title c">
        <h1>当前界面：赛事 》赛事发布 》发布审核 》<a class="nav-a">审核</a></h1>
            ...
            <div style="display:block;" class="box-detail-tab-item">
                ...
                <table class="mt15" style="table-layout:auto;">
                    ...
                    <tr>
                        ...
                        <td width="<?php echo ($_REQUEST['p_id']==0) ? '40%' : '90%'; ?>"><?php echo $model->state_name; ?></td>
                    </tr>
                    <tr>
						<td width="12%"><?php echo $form->labelEx($model,'reasons_failure'); ?></td>
						<td><?php echo ($model->state!=372 && $model->state!=373) ? $form->textField($model,'reasons_failure',array('class'=>'input-text')) : $model->reasons_failure; ?></td>
                    </tr>
                    <tr>
...
<script>
    function onIntroduction(id,num){
        var title;
        switch (num) {
            case 1: title = '裁判员须知'; break;
            case 2: title = '运动员须知'; break;
            default: title = '查看竞赛规程';
        }
