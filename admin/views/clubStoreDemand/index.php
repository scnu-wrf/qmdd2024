<?php //if (!isset($_REQUEST['service_type'])) {$_REQUEST['service_type']=520;} ?>
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>服务需求列表</h1></div><!--box-title end-->
    <div class="box-content">
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>关键字：</span>
                    <input style="width:200px;" class="input-text" placeholder="请输入服务标题或服务编号" type="text" name="keywords" value="<?php echo Yii::app()->request->getParam('keywords');?>">
                </label>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $model->getAttributeLabel('area');?></th>
                        <th><?php echo $model->getAttributeLabel('state');?></th>
                        <th><?php echo $model->getAttributeLabel('about_state');?></th>
                        <th><?php echo $model->getAttributeLabel('uDate');?></th>
                        <th><?php echo $model->getAttributeLabel('reasons_time');?></th>
                        <th><?php echo $model->getAttributeLabel('detail_gfid');?></th>
                        <th><?php echo $model->getAttributeLabel('site_contain');?></th>
                        <th><?php echo $model->getAttributeLabel('about_club_num');?></th>
                        <th>操作</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $index = 1; foreach($arclist as $v){ ?>
                        <tr>
                            ...
                            <td><?php echo $v->about_state_name; ?></td>
                            <td><?php echo $v->uDate; ?></td>
                            <td><?php echo $v->reasons_time; ?></td>
                            <td><?php echo $v->detail_gfname; ?></td>
                            <td><?php echo $v->site_contain; ?></td>
                            <td><?php echo $v->about_club_num; ?></td>
                            <td>
