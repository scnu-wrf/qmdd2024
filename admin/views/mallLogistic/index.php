<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>物流管理列表</h1></div><!--box-title end-->
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('f_mark');?></th>
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('f_url');?></th>
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('f_mobilec');?></th>
...
$index = 1;
 foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td style='text-align: center;'><?php echo $v->f_url; ?></td>
                        <td style='text-align: center;'><?php echo $v->f_mobilec; ?></td>
                        
                        <td style='text-align: center;'>
                            <a class="btn" href="<?php echo $this->createUrl('mallLogisticsFreight/index',array('pid' => $v->f_id ));?>" title="运费列表">运费列表</a>
