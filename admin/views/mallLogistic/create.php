<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>添加物流公司</h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span></div><!--box-title end-->
