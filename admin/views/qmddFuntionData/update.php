            ...
            <div style="display:block;" class="box-detail-tab-item">
                <table border="0" cellspacing="1" cellpadding="0" class="product_publish_content">
                    ...
                    <td><?php echo $form->labelEx($model, 'dispay_icon'); ?></td>
                        <td colspan="2" id="dpic_dispay_icon">
                        ...
                        <td colspan="2" id="dpic_dispay_click_icon">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <span id="dispay_box">
                                <?php foreach($dispay_type as $v){?>
                                    <span class="label-box" id="dispay_item_<?php echo $v->f_id;?>" data-id="<?php echo $v->f_id;?>">
                                        <?php echo $v->F_NAME;?>
                                        <i onclick="fnDeleteDispay(this);"></i>
                                    </span>
                                <?php }?>
                            </span>
                        ...
                        <td colspan="2">
                            ...
                            <div class="msg">*注占单行份数，如1为占单行一分之一空间；2为占单行二分之一空间，以此类推</div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <span id="project_box"><?php foreach($project_list as $v){?><span class="label-box" id="projectnot_item_<?php echo $v->id;?>" data-id="<?php echo $v->id;?>"><?php echo $v->project_name;?><i onclick="fnDeleteProject(this);"></i></span><?php }?></span>
