...
?>
<div class="box">
    <div class="box-title c"><h1>当前界面：视频》发布视频》发布视频》<a class="nav-a"><?php if($model->state==721){?>编辑<?php }else{?>详情<?php }?></a></h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回上一层</a></span></div><!--box-title end-->
        ...
        <div class="box-detail-bd">
			...
			<table>
				<tr>
					...
					<td width="35%"><?php echo $model->video_code; ?></td>
				...
				<tr>
					...
					<td width="35%">
						...
						<span id="publish_classify_box"><?php foreach($publish_classify as $v){?><span class="label-box" id="publish_classify_item_<?php echo $v->id;?>" data-id="<?php echo $v->id;?>"><?php echo $v->sn_name;?><i onclick="fnDeletePublishClassify(this);"></i></span><?php }?></span>
					...
					<td>
						...
						<span id="classify_box"><?php foreach($video_classify as $v){?><span class="label-box" id="classify_item_<?php echo $v->id;?>" data-id="<?php echo $v->id;?>"><?php echo $v->sn_name;?><i onclick="fnDeleteClassify(this);"></i></span><?php }?></span>
...
//从图库选择图片
var $Single=$('#BoutiqueVideo_video_logo');
