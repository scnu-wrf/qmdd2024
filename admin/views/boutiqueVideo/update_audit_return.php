<div class="box">
    <div class="box-title c"><h1>当前界面：视频》发布视频》发布视频》<a class="nav-a">详情</a></h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回上一层</a></span></div><!--box-title end-->
		...
		<div class="box-detail-bd">
			...
			<table>
				...
				<tr>
					<td>可执行操作</td>
					<td colspan="3">
						<a href="<?php echo $this->createUrl('update', array('id'=>$model->id));?>"><button id="chongbian" class="btn btn-blue" type="button">重新提交</button></a>
