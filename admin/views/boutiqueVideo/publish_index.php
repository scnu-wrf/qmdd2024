<div class="box">
    <div class="box-title c">
		<h1>当前界面：视频》发布视频》<a class="nav-a">发布视频</a></h1><span class="back"><a class="btn" href="javascript:;" onclick="we.reload();"><i class="fa fa-refresh"></i>刷新</a></span>
	</div><!--box-title end-->
				...
				<?php foreach($arclist as $k=>$v){ ?>
                    <tr>
                        ...
                        <td>
							...
							<?php }else{?><a class="btn" href="<?php echo $this->createUrl('update', array('id'=>$v->id));?>" title="详情">详情</a>
							<?php }?>
