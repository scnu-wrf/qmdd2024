<div class="box">
    <div class="box-title c"><h1>当前界面：视频》视频管理》各单位视频列表》<a class="nav-a">详情</a></h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span></div><!--box-title end-->
        ...
        <div class="box-detail-bd">
			...
			<table>
				...
				<tr>
					<td>可执行操作</td>
					<td colspan="3">
					<?php if($model->is_top==1){ ?>
						<button id="shanchu" onclick="we.notop('<?php echo $model->id;?>', notopUrl);" class="btn btn-blue" type="button"> 取消置顶</button>
						<?php } else{ ?>
						<button id="shanchu" onclick="we.istop('<?php echo $model->id;?>', istopUrl);" class="btn btn-blue" type="button"> 置顶</button>
					<?php }?>
