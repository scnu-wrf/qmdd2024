<div class="box">
    <div class="box-title c"><h1>当前界面：视频》发布视频》审核未通过列表》<a class="nav-a">详情</a></h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回上一层</a></span></div><!--box-title end-->
