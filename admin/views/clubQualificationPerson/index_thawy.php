<div class="box" div style="font-size: 9px">
    ...
    <div class="box-content">
        <div class="box-detail-tab mt15">
            <ul class="c">
                <li ><a href="<?=$this->createUrl('qualificationsPersonLock/index')?>">冻结</a></li>
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>冻结剩余日期：</span>
                    <input style="width:120px;" class="input-text" type="text" id="end_date" name="end_date" placeholder="请输入天数" value="<?php echo Yii::app()->request->getParam('end_date');?>">
                </label>
                <label style="margin-right:10px;">
                    <span>账号状态：</span>
...
function remedy(a,b){
    var str='';
    if(a=='check'){
        $.each($('.list tbody .check-item input:checkbox:checked'),function(){
            str+=$(this).val()+',';
        });
        if(str.length > 0){
