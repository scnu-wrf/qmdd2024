...
<html lang="zh">
        ...
        <script> 
            function test(msgx){
                art.dialog({
                    ...
                    content: msgx,
                    close: function () {
                        window.parent.document.location.reload(this);
                    }
                });
            } 
        </script>
    ...
    <body>
        <div class="box">
            <div class="box-title c"><h1><i class="fa fa-table"></i>导入服务者</h1></div><!--box-title end-->
                        ...
                        <tr>
                            <td>
                                <div>
                                    导入规则：<br>
                                    1.文件大小不超过2M。<br>
                                    2.一次导入服务者数据最多为200条。<br>
                                    3.服务者信息不能为空。<br>
                                    4.详细信息请下载模板查看。<br>
                                </div>
                            </td>
                            <td>
                                <a  class="btn" href="<?php echo Yii::app()->request->baseUrl.'/admin/views/clubQualificationPerson/服务者模板.xlsx';?>">下载信息模板</a>
                            </td>
                        </tr>
                    </table>
                </div> <!-- box-table -->
