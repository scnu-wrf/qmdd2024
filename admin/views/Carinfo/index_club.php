            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $model->getAttributeLabel('effective_time');?></th>
                ...
                <tbody><?php $basepath=BasePath::model()->getPath(130);?>
                    ...
                    <tr>
                        ...
                        <td><?php if (!empty($v->shopping_car->product_title)) echo $v->shopping_car->product_title; ?></td>
                        <td><?php if (!empty($v->ordertype->F_NAME)) echo $v->ordertype->F_NAME; ?></td>
                        <td><?php echo $v->money; ?></td>
                        <td><?php echo $v->order_money; ?></td>
                        <td>待支付</td>
                        <td><?php echo $v->total_money; ?></td>
                        <td><?php echo $v->effective_time; ?></td>
                        <td><?php echo $v->order_Date; ?></td>
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('update_club', array('id'=>$v->id));?>" title="编辑"><i class="fa fa-edit"></i></a>
                        </td>
                    </tr>
					<?php $index++; } ?>
                </tbody>
