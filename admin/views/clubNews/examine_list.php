<div class="box">
    <div class="box-title c">
        <span><h1>当前界面：资讯》资讯发布》资讯审核》待审核</h1></span>
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>审核日期：</span>
                    <input style="width:120px;" class="input-text" type="text" id="start_date" name="news_start_date" value="<?php echo Yii::app()->request->getParam('news_start_date');?>">
                    <span>-</span>
                    <input style="width:120px;" class="input-text" type="text" id="end_date" name="news_end_date" value="<?php echo Yii::app()->request->getParam('news_end_date');?>">
                </label>
...
?>
                    <tr>
                        ...
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('examine_update', array('id'=>$v->id));?>">审核</a>
                        </td>
                    </tr>
<?php $index++; } ?>
                </tbody>
