                ...
                <table class="mt15">
                    ...
                    <tr id="show_cont_line"><!--news_type=225时显示-->
                        ...
                        <td colspan="3">
                            ...
                            <script>we.editor('<?php echo get_class($model);?>_news_content_temp', '<?php echo get_class($model);?>[news_content_temp]');</script></span>
                           <script>var ue = UE.getEditor("editor_ClubNews_news_content_temp");ue.ready(function() {ue.setDisabled();});
                       </script>
...
setTimeout(function() {$('#edui1_toolbarbox').css('display','none');}, 500);
