            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th width="4%">序号</th>
                        <th width="5%"><?php echo $model->getAttributeLabel('news_type');?></th>
                        <th width="9%"><?php echo $model->getAttributeLabel('news_code');?></th>
                        <th width="10%"><?php echo $model->getAttributeLabel('news_pic');?></th>
                        <th width="24%"><?php echo $model->getAttributeLabel('news_title');?></th>
                        ...
                        <!-- 备份 -->
                        <th width="12%"><?php echo $model->getAttributeLabel('uDate');?></th>
                        <th width="10%">操作</th>
                    </tr>
                </thead>
                <tbody>
