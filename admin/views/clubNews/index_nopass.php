<div class="box">
    <div class="box-title c">
        <span><h1>当前界面：资讯》资讯发布》审核未通过列表</h1></span>
...
?>
                    <tr>
                        ...
                        <!-- 隐藏 俱乐部 代码 -->
                        <td style='display: none;'><?php echo $v->club_list; ?></td>
                        ...
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('nopass_check', array('id'=>$v->id));?>">查看</a>
