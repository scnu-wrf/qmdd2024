<div class="box">
    <div class="box-title c">
        <h1>当前界面：动动约》服务查询》<a class="nav-a">历史服务发布表</a></h1>
...
<?php $listdata2=QmddServerSetData::model()->find('list_id='.$v->id.' order by sale_price DESC'); ?>
			...
			?>
                        ...
                        <td><a class="btn" href="<?php echo $this->createUrl('qmddServerSetInfo/update_check', array('id'=>$v->info_id));?>" title="详情">详情</a>&nbsp;<a class="btn" href="javascript:;" onclick="fnMemberprice(<?php echo $v->id;?>);" title="可约服务明细">价格明细</a></td>
                    </tr>
<?php $index++; } ?>
                </tbody>
            </table>
