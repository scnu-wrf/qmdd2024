...
<div class="box">
    <div class="box-title c">
        <h1>当前界面：商城》商品发布》<a class="nav-a">商品发布列表</a></h1>
...
$detail=MallPriceSetDetails::model()->findAll('product_id='.$v->id.' and star_time<"'.$now.'" and end_time>"'.$now.'"'); ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('update_pass', array('id'=>$v->id,'flag'=>'list'));?>" title="详情">查看</a>
