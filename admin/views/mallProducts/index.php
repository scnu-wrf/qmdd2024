...
<div class="box">
    <div class="box-title c">
        <h1>当前界面：商城》商品发布》<a class="nav-a">商品发布申请</a></h1>
        <span class="back"><a class="btn" href="<?php echo $this->createUrl('index');?>"><i class="fa fa-refresh"></i>刷新</a></span>
    </div><!--box-title end--> 
    <div class="box-content">
    	<div class="box-header">
            <?php echo show_command('添加',$this->createUrl('create', array('id'=>0)),'发布新商品'); ?>
...
foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('create', array('id'=>$v->id));?>"><i class="fa fa-plus"></i></a>
