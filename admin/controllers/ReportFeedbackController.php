<?php
    ...
    class ReportFeedbackController extends BaseController {
        ...
        public function actionIndex($type = '', $searchtext = '', $state = '', $online = '', $start_date = '', $end_date = '', $keywords = '', $sorttype = '',$is_excel='') {
