...
class serviceGroupMemberController extends BaseController {
    ...
    public function actionCustomer_service_list($keywords = '') {
		...
		$criteria->join = 'left join service_group_member m on t.id=m.admin_id and t.club_id=m.club_id';//排除已添加客服
